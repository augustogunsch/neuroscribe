...
/* The settings page: one card per thing you might want to change.
 *
 * The account card is the only part of this app that genuinely needs the
 * server — how much of the plan is used is the one fact the browser cannot work
 * out alone. When there is no connection it shows the last answer and says so.
 */
