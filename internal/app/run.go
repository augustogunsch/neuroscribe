...
// The frontend, embedded next to itself in web/ and aliased here so that every
// reader in this package can go on saying "assets".
var assets = web.FS
...
// Main is the whole program. It lives here rather than in package main so that
// cmd/neuroscribe holds nothing but the call to it — there is no logic in this
// application that a test could not reach.
func Main() {
